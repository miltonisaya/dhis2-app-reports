        ...
        sections: [
            {
                ...
                rows: [
                  ...
                  {
                    label: 'Number of community media engaged in provision of health messages',
                    dxIds: { RADIO: 'Uo24UEq7wRo', TV: 'kwVQYuNsGzE', SOCIAL: 'pYpitLCVfqA', OTHERS: 'Wx8rYgdgRv6' },
                  },
                  ...
                  {
                    label: 'Number of mass media contents aired to address specific health area',
    ...
    },
    {
        ...
        sections: [
            ...
            },
            {
                ...
                showTotal: true,
                rows: [
                    { label: 'Chlorine tabs (water treatment)', dxId: 'S8FGFjPI3sS.qNVAh7PNVpz' },
                    { label: 'Condoms',                         dxId: 'S8FGFjPI3sS.n1tyRryHQeN' },
                    { label: 'Family planning',                 dxId: 'S8FGFjPI3sS.WE9yvfxj28t' },
                    { label: 'ITN',                             dxId: 'S8FGFjPI3sS.feCUCmuGW6H' },
                    { label: 'Preventive therapy',             dxId: 'S8FGFjPI3sS.Jk57SKc35G4' },
                    { label: 'Tests conducted',                dxId: 'S8FGFjPI3sS.t4ZP8BWDNcq' },
                    { label: 'Vaccine doses',                  dxId: 'S8FGFjPI3sS.FoApPaqmpCC' },
                    { label: 'Others',                         dxId: 'S8FGFjPI3sS.HpIB5dKEQMo' },
                ],
            },
            {
                ...
                showTotal: true,
                rows: [
                    { label: 'Caps',                dxId: 'S8FGFjPI3sS.lmWi02SKytK' },
                    { label: 'Khangas',             dxId: 'S8FGFjPI3sS.kZHz0llxb7g' },
                    { label: 'Leaflets/Brochures',  dxId: 'S8FGFjPI3sS.GpHrT6NvSSl' },
                    { label: 'Newsletters',         dxId: 'S8FGFjPI3sS.L6W0oJIAzEY' },
                    { label: 'Pens',                dxId: 'S8FGFjPI3sS.K9qv9HdqBV7' },
                    { label: 'Posters',             dxId: 'S8FGFjPI3sS.cIsr3NEi1Mp' },
                    { label: 'T-Shirts',            dxId: 'S8FGFjPI3sS.JX2rqoMog7L' },
                    { label: 'Umbrellas',           dxId: 'S8FGFjPI3sS.wZIaTyJnG57' },
                    { label: 'Wheel covers',        dxId: 'S8FGFjPI3sS.fRaNohaJOBR' },
                    { label: 'Others',              dxId: 'S8FGFjPI3sS.YKfPimRLiNJ' },
                ],
            },
            {
                ...
                showTotal: true,
                rows: [
                    { label: 'Gender desk',     dxId: 'S8FGFjPI3sS.y4d5n19mEwL' },
                    { label: 'Health facility', dxId: 'S8FGFjPI3sS.YLMtLP16NvZ' },
                    { label: 'Social welfare',  dxId: 'S8FGFjPI3sS.ewCPRtMOuef' },
                    { label: 'Other',           dxId: 'S8FGFjPI3sS.bEu7kDUA035' },
                ],
            },
            {
                id: 'mid-media-methods',
                title: 'Methods used to provide health education',
                type: 'simple',
                valueLabel: 'Number of times used',
                showTotal: true,
                rows: [
                    { label: 'Cinemas',               dxId: 'iGcvJo1zmkB' },
                    { label: 'Community theatres',    dxId: 'DBLQSqKc2dt' },
                    { label: 'Drama/Comedy',          dxId: 'd8hlEFO27ye' },
                    { label: 'Face to face',          dxId: 'ZYAaBSeNq6X' },
                    { label: 'Public announcements',  dxId: 'Q809k5pRXYX' },
                    { label: 'Traditional dances',    dxId: 'hkAigccVINb' },
                    { label: 'Others',                dxId: 'JRosNZxfB0i' },
                ],
            },
        ],
    },
